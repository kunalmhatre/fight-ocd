    ...
    <Wrapper>
      ...
      <WaysToContribute>
        <li>
          ...
          individuals in{" "}
          <Link to="https://discord.gg/ZUxkpMJC">our Discord community</Link>.
          Share your experiences, exchange ideas, and collaborate on initiatives
          aimed at combating OCD. Together, we can amplify our efforts and make
          a difference in the lives of those affected by this challenging
          disorder.
        </li>
        <li>
          ...
          you. Send us a message, and let's explore how we can work together to
          fight OCD and bring hope to those in need.
        </li>
        <li>
          <strong>Collaborate on GitHub:</strong> Are you a developer passionate
          about leveraging technology to make a meaningful impact in mental
          health? Join us in our mission to combat OCD by contributing your
          coding expertise to{" "}
